...
type ConnectorClient interface {
	...
	WatchWorkloads(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Connector_WatchWorkloadsClient, error)
...
func (c *connectorClient) WatchWorkloads(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Connector_WatchWorkloadsClient, error) {
...
type ConnectorServer interface {
	...
	// Watch all workloads in the mapped namespaces
	WatchWorkloads(*emptypb.Empty, Connector_WatchWorkloadsServer) error
	// Returns a stream of messages to display to the user.  Does NOT
	// require having called anything else first.
...
func (UnimplementedConnectorServer) WatchWorkloads(*emptypb.Empty, Connector_WatchWorkloadsServer) error {
